...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V5S/Debug/V5S_SmartCard.exe

dist/V5S/Debug/V5S_SmartCard.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V5S/Debug
	arm-brcm-linux-gnueabi-g++ -o dist/V5S/Debug/V5S_SmartCard ${OBJECTFILES} ${LDLIBSOPTIONS} -L . "-L${SDKV5SLIB}" "-L${SDKV5SLIBN}"
...
${OBJECTDIR}/deduct.o: deduct.c
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -I/cygdrive/C/Program\ Files/Castles/VEGA5000S/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA5000S/include -o ${OBJECTDIR}/deduct.o deduct.c

${OBJECTDIR}/getRNinfo.o: getRNinfo.c
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -I/cygdrive/C/Program\ Files/Castles/VEGA5000S/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA5000S/include -o ${OBJECTDIR}/getRNinfo.o getRNinfo.c

${OBJECTDIR}/loading.o: loading.c
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -I/cygdrive/C/Program\ Files/Castles/VEGA5000S/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA5000S/include -o ${OBJECTDIR}/loading.o loading.c

${OBJECTDIR}/showscreen.o: showscreen.c
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -I/cygdrive/C/Program\ Files/Castles/VEGA5000S/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA5000S/include -o ${OBJECTDIR}/showscreen.o showscreen.c
